...
class LicenseMiddleware
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $domain = domain();
        // Example: set LICENSE_KEY in .env to your number.
        $licenseKey = (string) config('app.license_key', '');
        $license_check = Cache::remember('license_check', 0 * 0 * 0, function () use ($licenseKey) {
